...
class User extends Component {
    ...
    renderUser = () => {
        ...
        if (this.state.users !== null) {
            return users.map((user, index) => {
                return (
                    <div key={index} style={{ display: 'flex', marginLeft: 20, backgroundColor: 'white', width: '500px', marginBottom: '20px', alignItems: 'center', height: '150px', borderRadius: 5 }}>
                        <div>
                            ...
                            alt="" style={{ width: '120px', height: '100px', marginLeft: 10 }} />
                        </div>
                        <div style={{ marginLeft: 20, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
    ...
    render() {
        return (
            <div style={{ display: 'flex', width: window.innerWidth + 'px', flexWrap: 'wrap', justifyContent: 'center', marginTop: 20 }}>
                {this.renderUser()}
            </div>
        )
    }
